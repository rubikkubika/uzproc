...
public class ContractStatusUpdateService {
     ...
     * - одноэтапное: "Согласование договора: Согласован, Регистрация: На регистрации"
     * - многоэтапное: Этап 1: Согласован + Этап 2: Согласован + "Регистрация: На регистрации"
    ...
    public void updateStatus(Long contractId) {
        ...
        if (state != null && !state.trim().isEmpty()) {
            ...
            // Проверяем точные совпадения для статуса "На регистрации"
                ...
                logger.debug("Contract {} state matches on registration condition (exact match): {}", contractId, stateTrimmed);
            }
            // Проверяем условия для статуса "На регистрации": согласование пройдено и регистрация в процессе
            // Этап 1: "Согласование договора - Этап 1: Согласован"; Этап 2: "Согласование договора - Этап 2: Согласован"
