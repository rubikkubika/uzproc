...
public class PurchaseRequest {
    ...
    public java.util.List<com.uzproc.backend.entity.purchase.Purchase> getPurchases() {
        return purchases;
    }

    public void setPurchases(java.util.List<com.uzproc.backend.entity.purchase.Purchase> purchases) {
