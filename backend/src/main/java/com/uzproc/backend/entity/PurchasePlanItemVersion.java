...
@Entity
@Table(name = "purchase_plan_item_versions")
public class PurchasePlanItemVersion {
    ...
    private PurchasePlanVersion version;

    @Column(name = "purchase_plan_item_id")
    ...
    public PurchasePlanItemVersion() {
    }
    ...
    public PurchasePlanVersion getVersion() {
        return version;
    }

    public void setVersion(PurchasePlanVersion version) {
