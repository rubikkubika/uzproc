...
| `SPECIFICATION_ON_COORDINATION` | Спецификация на согласовании | Для заказов: есть спецификация со статусом "На согласовании" |
...
### 4. **Спецификация на согласовании** (высокий приоритет для заказов)
- **Условие**: `hasOnCoordinationSpecification === true`
- **Тип заявки**: Заказы (`requiresPurchase === false`)
- **Статус**: `SPECIFICATION_ON_COORDINATION` ("Спецификация на согласовании")
- **Проверка**: Есть спецификация со статусом `ON_COORDINATION`

### 5. **Спецификация создана - Архив** (высокий приоритет для заказов)
...
### 6. **Спецификация создана** (высокий приоритет для заказов)
...
### 7. **Закупка не согласована** (высокий приоритет для закупок)
...
### 8. **Договор создан** (высокий приоритет для закупок)
...
### 9. **Закупка завершена** (высокий приоритет для закупок)
...
### 10. **Закупка создана** (средний приоритет для закупок)
...
### 11. **Заявка не утверждена** (низкий приоритет)
...
### 12. **Заявка не согласована** (низкий приоритет)
...
### 13. **Заявка утверждена** (низкий приоритет)
...
### 14. **Заявка на утверждении** (низкий приоритет)
...
### 15. **Заявка на согласовании** (низший приоритет)
...
- **Спецификация на согласовании**: `status = 'ON_COORDINATION'`
...
4. Рабочие дни считаются без учета субботы, воскресенья и дат из таблицы `holidays` в БД (праздники и иные нерабочие дни)
