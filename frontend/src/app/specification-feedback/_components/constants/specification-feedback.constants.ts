...
export const FEEDBACK_QUESTIONS: FeedbackQuestion[] = [
  {
    ...
    hint:
      'Скорость реагирования на потребность: насколько быстро отдел закупок отреагировал на вашу заявку и провёл её — от поступления потребности до подписания спецификации.',
  },
  {
    key: 'businessRating',
