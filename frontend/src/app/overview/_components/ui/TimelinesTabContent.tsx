...
const STAGE_HELP: Record<string, string> = {
  ...
  'Согласование договора': 'От первого назначения согласования договора до последнего завершения не-регистрационных этапов. Если несколько договоров — берётся самый долгий. День назначения не считается.',
  'Регистрация договора': 'От даты назначения регистрационного этапа до его завершения. Если несколько договоров — берётся самый долгий. День назначения не считается.',
  'Договор': 'Сумма этапов: Подготовка договора + Согласование договора + Регистрация договора.',
