...
const VALID_TABS: OverviewTab[] = ['sla', 'purchase-plan', 'csi', 'ek', 'approvals', 'timelines', 'savings', 'contract-remarks', 'contract-documents-count', 'contract-approvals', 'purchases-by-cfo', 'purchaser-distribution', 'kpi'];
