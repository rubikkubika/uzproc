...
export type OverviewTab = 'sla' | 'purchase-plan' | 'csi' | 'ek' | 'approvals' | 'timelines' | 'savings' | 'contract-remarks' | 'contract-documents-count' | 'contract-approvals' | 'purchases-by-cfo' | 'purchaser-distribution' | 'kpi';
...
export const DASHBOARD_CATEGORY_TABS: Record<OverviewDashboardCategory, OverviewTab[]> = {
  ...
  other: ['approvals', 'timelines', 'purchases-by-cfo', 'purchaser-distribution'],
};
