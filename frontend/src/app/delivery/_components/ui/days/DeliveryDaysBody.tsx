...
/**
 * Тело блока «По дням»: сверху горизонт («что горит»), ниже лента месяца.
 * Клик по группе или дню фильтрует таблицу; выбор группы снимает день и наоборот.
 */
export default function DeliveryDaysBody({ cards, onToggleHorizon, days, month, onToggleDay }: Props) {
  return (
    <div className="flex flex-col gap-2 px-3 py-2.5 overflow-x-auto">
