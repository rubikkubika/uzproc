...
/**
 * Пропсы для компонента PurchaserCompanyFilterDropdown
 */
export interface PurchaserCompanyFilterDropdownProps {
...
/**
 * Компонент фильтра Компания закупщика
 * 
 ...
 */
export default function PurchaserCompanyFilterDropdown({
  isOpen,
  position,
  searchQuery,
  options,
  ...
  onClose,
  buttonRef,
}: PurchaserCompanyFilterDropdownProps) {
  return (
