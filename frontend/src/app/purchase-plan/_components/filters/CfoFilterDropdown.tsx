...
/**
 * Пропсы для компонента CfoFilterDropdown
 */
export interface CfoFilterDropdownProps {
 ...
 */
export default function CfoFilterDropdown({
  isOpen,
  position,
  searchQuery,
  options,
