...
export type GuideBlock =
  ...
  /** Пара «плохая / хорошая формулировка предмета» из позиций драфта */
...
export interface GuideSubjectExamples {
  /** Название контрагента или номер вместо предмета */
  bad: string | null;
  /** Понятная формулировка «что, для кого и зачем» */
  good: string | null;
}
...
export interface GuideData {
  ...
  /** Примеры формулировок предмета закупки */
