 ...
 */
export default function PaymentsTableTabs({ activeTab, onTabChange, tabCounts, actions }: PaymentsTableTabsProps) {
  return (
    <div
      className="flex items-center justify-between gap-2 px-3 pt-1 pb-1 bg-white border-b border-gray-200 flex-shrink-0"
